...
public class WriteToXlsx {
 public static void main(String[] args) throws IOException {
  FileInputStream fis = new FileInputStream(new File("C:\\Users\\deept\\Desktop\\Java Assignments\\src\\com\\company\\assignment7\\test.xlsx"));
  XSSFWorkbook workbook = new XSSFWorkbook (fis);
  XSSFSheet sheet = workbook.getSheetAt(0);
  //Create First Row
  XSSFRow row1 = sheet.createRow(0);
  XSSFCell r1c1 = row1.createCell(0);
  r1c1.setCellValue("Student Id");
  ...
  fis.close();
  FileOutputStream fos =new FileOutputStream(new File("C:\\Users\\deept\\Desktop\\Java Assignments\\src\\com\\company\\assignment7\\test.xlsx"));
  workbook.write(fos);
  fos.close();
